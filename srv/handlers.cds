...
//     FINALRESAON: String;
//     REASONTYPE: String;
//     ERROR_REASON: String; // Add this if you want to support invalid field in input
// }

// service ECommerceService {
//     entity Employees as projection on ecommerce.Employees;
//     entity InvalidEmployees as projection on ecommerce.InvalidEmployees; // <--- Add this!
...
service ECommerceService {
    entity Employees as projection on ecommerce.Employees;
    entity InvalidEmployees as projection on ecommerce.InvalidEmployees;
    ...
    action saveInvalidEmployees(records: array of EmployeeInput) returns {
        message: String;
    };
}